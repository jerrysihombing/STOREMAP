<?php
	...
	include_once(dirname(__FILE__) . "/../php/conf/ftp.mkg.conf.php");
    ...
    $msgToSend = "";
	# yymm
	$SRC = date("ym", strtotime("-1 days"));
	# yyyymmdd
	$FORM = date("Ymd", strtotime("-1 days"));
	# dd/mm/yy
	$dayToProcess = date("d/m/y", strtotime("-1 days"));
	# file location
